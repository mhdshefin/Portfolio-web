    ...
    return (
        <div id='contact' className='flex flex-col w-full sm:mt-20 sm:pt-20 pt-24 mt-0'>
            <div className='flex items-center justify-center text-white z-10'>
                <h1 className='font-bold text-4xl sm:text-5xl transition-all duration-500 z-10 hover:text-transparent bg-clip-text bg-gradient-to-r from-[#cd0383] to-[#7729ff]'>Contact me</h1>
            </div>
