...
const Header = () => {
    ...
    return (
        <div id='header' className={`w-full flex flex-col-reverse sm:flex sm:flex-row mt-[-80px] sm:mt-0 sm:pt-24 px-[10%] h-[90vh]`}>
            <div className='flex flex-col sm:w-[50%] w-full items-center mt-5 sm:mt-0 sm:items-start justify-center'>
            ...
            <div className='flex flex-col sm:w-[50%] w-full items-center sm:mt-0 mt-[-35px] justify-center'>
