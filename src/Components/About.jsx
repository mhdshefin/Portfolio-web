...
const About = () => {
    return (
        <div id='about' className='w-full sm:mt-20 mt-16 sm:pt-24 pt-24'>
            <div className='flex items-center justify-center text-white'>
                <h1 className='font-bold text-5xl transition-all duration-500 hover:text-transparent bg-clip-text bg-gradient-to-r from-[#cd0383] to-[#7729ff]'>About me</h1>
            </div>
            ...
            <div className='sm:flex sm:mt-[-25vh] mt-[-40vh]'>
                <div className='sm:w-1/3 w-full sm:pl-10 p-10 flex items-center justify-center '>
                    <img className='rounded-xl h-[40vh] relative z-10 shadow-md ' src={assets.about_img} alt="" />
                </div>
