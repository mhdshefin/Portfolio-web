...
const NavBar = () => {
    ...
    return (
        <div className={`w-full h-14 sm:h-20 fixed top-0 left-0 right-0 z-40 transition-all duration-700 ${scrolled ? 'bg-[#0b0b0be7]' : 'bg-transparent'}`}>
            <div className='px-5 sm:px-10 md:px-14 flex justify-between'>
                ...
                <div className={`fixed top-0 bottom-0 right-0 overflow-hidden transition-all z-50 ${visible ? 'w-1/2' : 'w-0'}`}>
